...
cueBlockLength_shortP       = 16;  % 28;% short predictive block, +/-jitter    || 24, total for 4* short blocks = 144
cueBlockLength_longP        = 32; % 76;% long predictive block, +/-jitter     || 60, total for 2* long blocks  = 96
...
save(fullfile(['sequence3_tutorial']), 'cueProbabilityOutput', 'blockParams', 'breaks');
end