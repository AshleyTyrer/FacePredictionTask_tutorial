%% Define parameters
%
% Project: CWT task - tutorial version
%
% Sets key parameters, called by main_Ashley_tutorial.m
%
% Created by Niia Nikolova
% Edited by Ashley Tyrer
% Last edit: 07/05/2023
...
%% Procedure
vars.trialSequenceType = 2; % 1 = half-length (128 trials), more reversals. 2 = half-length, fewer reversals. 3 = normal length (264 trials)
if vars.trialSequenceType == 1
    vars.NTrialsTotal = 128;  % 264;
    vars.PredEveryXTrials = 16;
elseif vars.trialSequenceType == 2
    vars.NTrialsTotal = 128;  % 264;
    vars.PredEveryXTrials = 16;
else
...
% createCueProbabilities(vars);

if vars.trialSequenceType == 1
    chosenSequence = 'sequence2_tutorial.mat'; % MAKE SURE TO CHOOSE TUTORIAL TRIAL SEQUENCE!!
elseif vars.trialSequenceType == 2
    chosenSequence = 'sequence3_tutorial.mat';
else
    chosenSequence = 'sequence5_NEW2.mat';
end
