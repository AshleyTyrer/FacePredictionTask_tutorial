function main_Ashley_tutorial(vars, scr)
%function main_Ashley(vars, scr)
%
...
try
    ...
    if vars.runCWTtutorial 
          cwtTutorial_Ashley_tutorial(scr, keys, vars);
    ...
    while endOfExpt ~= 1       % General stop flag for the loop
        ...
        thisTrialCue = ['cue_tutorial_', num2str(thisCue), '.tif'];          % ASHLEY -- this is where we load the cue image!!!
